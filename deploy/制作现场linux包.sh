...
# 产物: 仓库根 bufferc-linux-x64.tgz（现场包：9 台 PLC 占位 192.168.1.10~18（MAGV03B01~09；B03=16 站其余 8 站）、baseUrl 空、webPort 7001、logLevel info）
set -e
...
echo "== [2/3] 覆盖现场模板 config.json（baseUrl 空 / 9 台 PLC 占位 / webPort 7001 / logLevel info）"
python - <<'PYEOF'
import json
